        ...
        <fieldset className="footer">
          ...
          <div className="action container">
            <div className="action__item">
              <h3 className="action__logo   icon-logo" />
          ...
          <div className="copyright container">
            ...
            <div>
              <img className="copyright__img" src={IMAGES.icon_visa} />
              <img className="copyright__img "src={IMAGES.icon_master  }/>
              <img className="copyright__img "src={IMAGES.icon_paypay}/>
              <img className="copyright__img "src={IMAGES.icon_ippay}/>
              <img className="copyright__img "src={IMAGES.icon_g_pay}/>
            </div>
          </div>
        </fieldset>
      </footer>
